...
const OrderData = ({ index, data, admin }) => {
  ...
  const overlayStyle = {
    backgroundColor: "#808080", // Adjust the opacity as needed
  };
  ...
  return (
    <motion.div
      ...
      style={overlayStyle}
      className="w-full flex flex-col items-start justify-start px-3 py-2 border relative border-gray-300 drop-shadow-md rounded-md gap-4"
    >
      <div className="w-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <p
            className={`text-base font-semibold border border-gray-300 px-2 py-[2px] rounded-md ${
