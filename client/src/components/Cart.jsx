  ...
  const handleCheckOut = () => {
    ...
    axios
      ...
      .catch((err) => {
        ...
        // Handle the error more gracefully and provide user feedback
        // dispatch(alertError("Failed to initiate checkout. Please try again."));
      });
  };
          ...
          <>
            <div className="flex flex-col w-full items-start justify-start gap-3 h-[65%] overflow-y-scroll scrollbar-none px-4 ">
              ...
              <div className="bg-zinc-800 rounded-t-[60px] w-full h-[35%] flex flex-col items-center justify-center px-4 py-6 gap-4">
                ...
                <motion.div
                  {...buttonClick}
                  className="bg-orange-400 w-[70%] px-4 py-3 text-xl text-headingColor font-semibold hover:bg-orange-500 drop-shadow-md rounded-2xl flex items-center justify-center cursor-pointer"
